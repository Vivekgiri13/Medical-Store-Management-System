...
def open_win():
    ...
    apt = Tk()
    apt.title("Interface")
    Label(apt, text=" India MEDICAL STORE ").grid(row=0, column=0, columnspan=3)
...
def make_bill():
    ...
    m += "===============================================\n"
    m += "                                  No :%s\n\n" % det[5]
    m += " India MEDICAL STORE COMPANY\n"
    m += " Mahuva BRANCH, BvnL\n\n"
    m += "-----------------------------------------------\n"
    if t == 1:
        m += "Name: %s\n" % named
        m += "Address: %s\n" % addd
...
def again():
    ...
    Label(root, text='India MEDICAL STORE COMPANY').grid(row=0, column=0, columnspan=5)
    Label(root, text="Mahuva BRANCH, Bhavnagar").grid(row=1, column=0, columnspan=5)
...
def open_cus():
    ...
    apt = Tk()
    apt.title("Interface")
    Label(apt, text="*** India MEDICAL DRUG STORE ***", bg='blue', fg='white').grid(row=0, column=0)
